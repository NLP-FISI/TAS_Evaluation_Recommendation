...
class EvaluationChallengeService:
    ...
    def procesar_evaluacion_reto(cls, reto_input: RetoParaEvaluar, retador_data: UsuarioData, contrincante_data: UsuarioData) -> ResultadoEvaluacion:
        ...
        # --- ÚNICO CAMBIO LÓGICO: Usar .puntos en lugar de .puntaje_elo ---
        elo_retador_actual = retador_data.puntos
        elo_contrincante_actual = contrincante_data.puntos
        # ------------------------------------------------------------------
        ...
        return ResultadoEvaluacion(
            ...
            id_retador=retador_data.id_usuario,
            ...
            id_contrincante=contrincante_data.id_usuario,
